...
{
    public class GXTimeConverter : JsonConverter
    {
        public override bool CanConvert(Type objectType)
        {
            return objectType == typeof(GXTime);
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            if (value == null)
                return null;
            return new GXTime() { Value = value.Date };
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            writer.WriteValue(JsonConvert.SerializeObject(new GXDateTimeSaveModel() { Date = date.Value, Skips = DateTimeSkips.Year | DateTimeSkips.Month | DateTimeSkips.Day | DateTimeSkips.DayOfWeek }));
        }
    }
    ...
    /// </summary>
    [JsonConverter(typeof(GXTimeConverter))]

...
{
    public class GXDateTimeConverter : JsonConverter
    {
        public override bool CanConvert(Type objectType)
        {
            return objectType == typeof(GXDateTime);
        }
        ...
        {
            var date = (GXDateTime)value;
            writer.WriteValue(JsonConvert.SerializeObject(new GXDateTimeSaveModel() { Date = date.Value, Skips = date.Skip }));
        }
    }

    [JsonObject]
    public class GXDateTimeSaveModel
    {
        public DateTimeOffset Date { get; set; }
        public DateTimeSkips Skips { get; set; }
    }
    ...
    /// </summary>
    [JsonConverter(typeof(GXDateTimeConverter))]
    public class GXDateTime : IConvertible
    {
        ...
        public GXDateTime(GXDateTimeSaveModel value) 
        {
            Value = value.Date;
            if (value.Date.DateTime.IsDaylightSavingTime())
            {
                Status |= ClockStatus.DaylightSavingActive;
            }
        ...
        object IConvertible.ToType(Type conversionType, IFormatProvider provider)
        {
            ...
            {
                return JsonConvert.SerializeObject(new GXDateTimeSaveModel() { Date = Value, Skips = Skip });
